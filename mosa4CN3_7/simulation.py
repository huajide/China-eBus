    ...
    def simulation(self, sim_v: SimVehicle,
        ...
        if self.trip_idx == 1:  # For the first trip of every sim_v
            ...
            try:
                ...
                interval = 9999.9
            # cd充电需求
            cd: int or List[int] = (lambda x, y: 1 if (x <= y) | (interval >= 60) else 0)(soc_trip * sim_v.battery,
            ...
            cd = (lambda x, y: 1 if (x <= y) | (interval >= 60) else 0)(soc_trip * sim_v.battery,next_trip_energy-min_energy)
